                ...
                <div className="flex items-center gap-4">
                    {user ? (
                        <>
                            ...
                            <button
                                className="bg-red-500/10 border border-red-500/20 text-red-400 hover:bg-red-500/20 px-4 py-2 rounded-lg transition-all text-sm font-medium"
                        ...
                        <>
                            ...
                            <button
                                className="bg-[#1f6feb] hover:bg-[#3182ce] text-white px-5 py-2 rounded-lg font-medium transition-all text-sm border border-[#1f6feb] shadow-[0_0_15px_rgba(49,130,206,0.3)]"
